...
public class Zoo {
    ...
    public void addAnimals(String filePath, String fileFormat) {
        if (fileFormat.equals("xml")) {
            addAnimalsXML(filePath);
        } else if (fileFormat.equals("json")) {
            addAnimalsJson(filePath);
        } else System.out.println("Плохой формат");
    }
     ...
     *
     * @param xmlPath path to JSON file with animals info
     */
